...
Load [defense-rules.md]({baseDir}/references/defense-rules.md).
...
Produce defense stance per file using the format from [output-format.md]({baseDir}/references/output-format.md):
