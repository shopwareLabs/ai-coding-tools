...
digraph reconcile {
  ...
  "Per contested finding: load detection algorithm via get_rules, apply to code" [shape=box];
  ...
  "peer: load own + peer findings on shared files" -> "Per contested finding: load detection algorithm via get_rules, apply to code";
  "adversary: load own stance + adversary challenges" -> "Per contested finding: load detection algorithm via get_rules, apply to code";
  "Per contested finding: load detection algorithm via get_rules, apply to code" -> "Evidence decides disposition — never social pressure";
...
1. Load the detection algorithm: `mcp__plugin_test-writing_test-rules__get_rules(ids={rule_id})`
